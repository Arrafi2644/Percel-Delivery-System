...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isUserExist.isActive === user_interface_1.IsActive.INACTIVE || isUserExist.isActive === user_interface_1.IsActive.BLOCKED) {
            throw new appError_1.default(http_status_codes_1.default.BAD_REQUEST, `User is ${isUserExist.role}`);
        }
